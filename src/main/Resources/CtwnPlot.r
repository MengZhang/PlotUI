...
# List all ACMO files
files <- list.files(path="C:/AgMIP Tools/Data/Phase 2 Harmonized Data/CIWARA/Navrongo/Maize/CTWN", pattern="ACMO*", full.names=T, recursive=FALSE)
for(d in 1:length(files)) {
#data <- read.csv(file=files[d],skip = 2, head=TRUE,sep=",",na.strings=c(""," ")) 
